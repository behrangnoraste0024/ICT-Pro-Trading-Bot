...
def format_strategy_comparison_report(
    ...
    lines = [
        ...
        "",
        "Comparison Table:",
        "Rank | Strategy | DR Mode | Exit | MinRR | Dir | TrendFB | Regime | Lookback | Thr | RegimeFB | Trades | W/L | Win% | NetPnL | AvgPnL | MaxDD | PF | LongPnL | ShortPnL | Dups | Elapsed",
    ]
...
def _format_row(row: StrategyComparisonRow) -> str:
    return (
        ...
        f"{_fmt(row.min_risk_reward)} | {row.direction_mode} | {row.auto_trend_fallback} | "
